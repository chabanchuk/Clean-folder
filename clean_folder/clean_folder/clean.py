...
def sort_files(path):
    ...
    print(f'Список файлів в категорії - Документи: {documents}')
    print(f'та розширення файлів документів: {set(documents_ext)}')
    print(f'Список файлів в категорії - Фото: {images}')
    print(f'та розширення фотофайлів: {set(images_ext)}')
    print(f'Список файлів в категорії - Відео: {video}')
    print(f'та розширення видеофайлів: {set(video_ext)}')
    print(f'Список файлів в категорії - Аудіо: {audio}')
    print(f'та розширення аудіофайлів: {set(audio_ext)}')
    print(f'Список файлів в категорії - Архиви: {archives}')
    print(f'та розширення архивів: {set(archives_ext)}')
    print(f'Список файлів в категорії - Файли з невідомим розширенням: {dont_now}')
    print(f'та їх розширення, які невідомі Скрипту:{set(dont_now_ext)}')
    print(f'Всі відомі Скрипту розширення знайдені ним у цільовій папці: {set(documents_ext)^set(images_ext)^set(video_ext)^set(audio_ext)^set(archives_ext)}')
